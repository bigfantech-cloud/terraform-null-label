...
Label output for resources naming conventions, and tags.
...
```
project_name
  ID element. Usually an abbreviation of project or brand name, to help ensure generated IDs are globally unique
```
