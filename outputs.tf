...
output "project_name" {
  value       = local.enabled ? local.project_name : ""
  description = "Normalized project_name"
}

output "aws_estate" {
  value       = local.enabled ? local.aws_estate : ""
  description = "Normalized aws_estate"
}
...
output "delimiter" {
  ...
  description = "Delimiter between `project_name`, `aws_estate`, `environment`, `stage`, and `attributes`"
}
